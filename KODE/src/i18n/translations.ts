...
export const translations = {
  nav: {
    ...
    myCart: { da: "Min kurv", en: "My cart" },
  },
  hero: {
    headline: {
      da: "tekstiltryk og print uden bøvl",
      en: "Professional textile printing for businesses, events and brands",
    },
    subheadline: {
      da: "Vi leverer tekstiltryk, folie og print til brands, virksomheder, private og alle derimellem",
  ...
  about: {
    ...
    description: {
      da: "Trykeksperten er et moderne trykkeri i København med speciale i tekstiltryk, t-shirt tryk, firmatøj og storformatprint. Vi hjælper virksomheder, foreninger og events med at få deres brand ud i verden – på alt fra tøj og merchandise til bannere, plakater og skilte. Vores mål er enkelt: høj kvalitet, fair priser og en proces der er nem for kunden. Trykeksperten blev startet for tre år siden som et nyt lokalt trykkeri i København. Allerede fra begyndelsen fik vi en stærk start med en aftale med Danmarks førende padel-tennis kæde. I samarbejde med dem har vi produceret tusindvis af stykker sportstøj med tryk, samt leveret udskåret folie og wayfinding til deres centre rundt i landet. Samarbejdet gav os et solidt fundament og erfaring med både større produktioner og projekter, hvor kvalitet og leveringstid er afgørende. Siden da har flere velkendte virksomheder valgt at samarbejde med Trykeksperten. I dag arbejder vi med både små og store opgaver – fra enkelte t-shirts til større produktioner af firmatøj, merchandise og eventmaterialer. Det unikke ved Trykeksperten er, at vi favner både det store og det små. Uanset om du skal bruge få produkter til en idé, eller en større produktion til din virksomhed, hjælper vi med at finde den rigtige løsning. Hos os handler det ikke kun om at trykke et logo på et produkt. Vi rådgiver også om valg af tøj og materialer, placering og størrelse på trykket, holdbarhed og kvalitet samt den bedste løsning til dit brand eller event. Vi ved, at et godt resultat kræver både det rigtige produkt, det rigtige tryk og den rigtige rådgivning. Har du en idé, et projekt eller en virksomhed der skal bruge tøj med tryk, merchandise eller storformatprint, så står vi klar til at hjælpe. Ring eller skriv til os – vi er sikre på, at vi kan skabe noget rigtig godt sammen.",
